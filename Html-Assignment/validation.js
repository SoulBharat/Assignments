...
function navalidation() {
  ...
  if (user == "") 
  {
    document.getElementById("username").innerHTML = "Plaease Fill Valid  Name";
    console.log("hekeke")
  }
  else if (user.length <5)
  {
    document.getElementById("username").innerHTML = "Minum length not matched";
...
if (vaemail == "") 
  {
    document.getElementById("validmail").innerHTML = "Plaease Fill the required mail";
    console.log("hekeke")
...
{ 
  ...
  if (pass == "") 
  {
    document.getElementById("validpass").innerHTML = "Plaease Fill the required mail";
    console.log("hekeke")
...
else if(passw.test(pass))
{
  ...
  document.getElementById("validpass").innerHTML=" Email is not valid "
  return false;
}
...
function confirm()
{
  ...
  if (password!= confirmpass)
   {
    document.getElementById("validconfirm").innerHTML=" Email is not same "
      return false;
    }

else{
  document.getElementById("validconfirm").innerHTML=" Email is  correct"
}
}
...
{ 
      ...
      var phone= /^(?:(?:\+|0{0,2})91(\s*[\ -]\s*)?|[0]?)?[6789]\d{9}|(\d[ -]?){10}\d$/;
    
      if (mobile == "") 
      {
        document.getElementById("validmobile").innerHTML = "Plaease Fill the required number";
        console.log("hekeke")
